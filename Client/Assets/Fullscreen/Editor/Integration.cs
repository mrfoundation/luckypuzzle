...
namespace FullscreenEditor {
    ...
    public static class Integration {
        ...
        private static string[] GetAllDefines() {
            ...
            var scriptDefines = PlayerSettings.GetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(currentBuildTarget));
        ...
        private static void SetAllDefines(string[] value) {
            var currentBuildTarget = EditorUserBuildSettings.selectedBuildTargetGroup;
            var currentScriptDefines = PlayerSettings.GetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(currentBuildTarget));
            ...
            PlayerSettings.SetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(currentBuildTarget), scriptDefines);
